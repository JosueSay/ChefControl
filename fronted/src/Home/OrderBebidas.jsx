...
import './OrderBebidas.css';

function OrderBebidas() {
  ...
  const fetchPedidos = () => {
    fetch('http://localhost:3000/pedidos-bebidas')
  ...
  return (
    <div className="OrderBebidas">
      <h2>Órdenes de Bebidas Pendientes</h2>
